...
HD_PWD='C:/Users/speqtral/XilinxVivado/Cmod-s7-uart-hello-world/Cmod-s7-uart-hello-world.runs/uart_microblaze_mcs_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_microblaze_mcs_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_microblaze_mcs_0_0.tcl
