...
entity uart_hello_world is
  ...
  attribute CORE_GENERATION_INFO of uart_hello_world : entity is "uart_hello_world,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=uart_hello_world,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of uart_hello_world : entity is "uart_hello_world.hwdef";
end uart_hello_world;

architecture STRUCTURE of uart_hello_world is
  component uart_hello_world_microblaze_mcs_0_0 is
  port (
    Clk : in STD_LOGIC;
    Reset : in STD_LOGIC;
    UART_txd : out STD_LOGIC
  );
  end component uart_hello_world_microblaze_mcs_0_0;
...
microblaze_mcs_0: component uart_hello_world_microblaze_mcs_0_0
     port map (
      Clk => Input_Clk_1,
      Reset => Reset_Top_1,
